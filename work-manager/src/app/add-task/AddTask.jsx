...
const AddTask = () => {
  ...
  return (
    <div className="grid grid-cols-12  justify-center">
      <div className="col-span-4 col-start-5 p-5 shadow-gray-400 shadow-sm">
        ...
        <form action="#!" onSubmit={handleAddTask}>
          ...
          <div className="mt-4">
            ...
            <textarea
              type="text"
              className="w-full p-3 rounded-3xl bg-gray-800 focus:ring-gray-400 border border-gray-800 content-input"
              id="task_content"
              rows={5}
              name="task_content"
              onChange={(event) => {
